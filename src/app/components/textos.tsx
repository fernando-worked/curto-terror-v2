...
const schizophrenia: Texto = {titulo: "schizophrenia", texto: `Os fatos a seguir são frutos de uma mente conturbada e eu não aconselho ou estimulo que os sigam em qualquer aspecto.
...
export const acervoTextos: Texto[] = [schizophrenia, schizophrenia1, schizophrenia2];